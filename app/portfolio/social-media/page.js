...
import { socialMediaProjects, smCategories } from "@/data/socialMediaProjects";
...
/* ═══════════════════════════════════════════════════════
   Social Media Portfolio Page
   E-commerce / Promotional grid layout with filtering
   ═══════════════════════════════════════════════════════ */
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white">
            أعمال منشورات التواصل الاجتماعي
          </h1>
        </motion.div>

        {/* Subtitle */}
        <motion.p variants={fadeUp} className="text-muted text-base md:text-lg max-w-2xl pe-5">
          تصاميم تسويقية تتصدر الخوارزميات وتحول المتابعين إلى عملاء
        </motion.p>
      </motion.div>
